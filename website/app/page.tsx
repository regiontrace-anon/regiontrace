...
import { ArrowUpRight, ArrowRight, Scan, MoveUpRight, Download, BookOpen, Code2, RotateCcw, ChevronRight } from 'lucide-react';
...
export default function Home(){
 ...
 <section id="overview" className="hero wrap">
  <div className="hero-copy"><div className="eyebrow"><span className="live-dot"/> A TOOLBOX FOR MULTIMODAL INTERPRETABILITY</div><h1>Every answer.<br/>A visual <span className="serif">trace.</span></h1><p className="hero-description">Trace how image regions support multimodal generation. Locate the evidence behind an error, and follow its influence as an explanation unfolds.</p><div className="hero-actions"><a className="button primary" href="#explorer">Try the example <ArrowRight size={18}/></a><a className="text-link" href="#method">Meet RegionTrace <ArrowUpRight size={17}/></a></div><div role="group" aria-label="Project links" style={{display:"flex",flexWrap:"wrap",gap:12,marginTop:20}}><a className="paper-link" href="https://github.com/regiontrace-anon/regiontrace" target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={15}/></a><a className="paper-link" href="https://github.com/regiontrace-anon/regiontrace/tree/main/code" target="_blank" rel="noreferrer"><Code2 size={17}/> Code <ArrowUpRight size={15}/></a></div><div className="hero-foot"><span>Fixed answer</span><i/> <span>Vary regions</span><i/><span>Trace generation</span></div></div>
