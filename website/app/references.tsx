...
.citation{font-size:.7em;line-height:0;vertical-align:super;margin-left:4px;white-space:nowrap}.citation a{color:#345f48;text-decoration:none}.citation a:hover{text-decoration:underline}.references-section{border-top:1px solid #dce2d8}.reference-list{list-style:none;padding:0;margin:32px 0 0;display:block}.reference-list li{display:flex;align-items:flex-start;gap:14px;padding:23px 0;border-top:1px solid #dce2d8;scroll-margin-top:110px}.reference-list li:target{background:#edf3e7;border-radius:5px;outline:8px solid #edf3e7}.reference-number{font:12px monospace;color:#78906b;padding-top:4px}.reference-list .reference-entry{min-width:0;font-size:15px;line-height:1.9;color:#657160}.reference-entry a{color:#273a30;text-decoration:underline;text-decoration-color:#bdcbb5;text-underline-offset:4px}.reference-entry a:hover{color:#345f48;text-decoration-color:currentColor}.reference-list h3{font-size:16px;line-height:1.6;margin:7px 0}.reference-list h3 a:hover{color:#345f48;text-decoration:underline;text-underline-offset:3px}.reference-list h3 svg{display:inline;vertical-align:middle;margin-left:5px}.reference-list p{font-size:13px;color:#788472;line-height:1.8}.reference-list .reference-label{font-size:11px;letter-spacing:1px;color:#547249;text-transform:uppercase}.study-sources{font-size:13px;line-height:1.9;color:#788472;margin:-10px 0 28px}@media(max-width:760px){.reference-list{grid-template-columns:1fr}}
`}</style><div className="section-heading"><div><div className="eyebrow">DATASETS · MODELS · FOUNDATIONS</div><h2>References</h2></div><p>Sources for the methods and resources used here.</p></div><ol className="reference-list">{references.map((r,i)=><li key={r.id} id={`ref-${r.id}`}><span className="reference-number">[{i+1}]</span><p className="reference-entry">{r.authors}. <a href={r.url} target="_blank" rel="noreferrer">{r.title}.</a> {r.venue}.</p></li>)}</ol></section>}
